...
#define MP_MBTN3         (MP_MBTN_BASE+3)
#define MP_MBTN4         (MP_MBTN_BASE+4)
#define MP_MBTN5         (MP_MBTN_BASE+5)
#define MP_MBTN6         (MP_MBTN_BASE+6)
...
#define MP_WHEEL_BASE     (MP_KEY_BASE+0x100)
#define MP_WHEEL_UP       (MP_WHEEL_BASE+0)
#define MP_WHEEL_DOWN     (MP_WHEEL_BASE+1)
#define MP_WHEEL_LEFT     (MP_WHEEL_BASE+2)
#define MP_WHEEL_RIGHT    (MP_WHEEL_BASE+3)
#define MP_WHEEL_END      (MP_WHEEL_BASE+4)

#define MP_KEY_IS_WHEEL(code) \
    ((code) >= MP_WHEEL_BASE && (code) < MP_WHEEL_END)
...
#define MP_KEY_DEPENDS_ON_MOUSE_POS(code) \
    (MP_KEY_IS_MOUSE_CLICK(code) || MP_KEY_IS_WHEEL(code) || \
