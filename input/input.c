...
static int map_legacy_wheel_keycode(int code)
{
    switch (code) {
    case MP_MBTN3: return MP_WHEEL_UP;
    case MP_MBTN4: return MP_WHEEL_DOWN;
    case MP_MBTN5: return MP_WHEEL_LEFT;
    case MP_MBTN6: return MP_WHEEL_RIGHT;
    default: return 0;
    }
}
                                   ...
                                   int code)
{
    ...
    if (!cmd && map_legacy_wheel_keycode(code)) {
        // Some input sources use mouse button numbers to refer to the mouse
        // wheel. Map these buttons to wheel keycodes and try again.
        code = map_legacy_wheel_keycode(code);
